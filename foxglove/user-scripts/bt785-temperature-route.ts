...
export const output = "/analysis/bt785_temperature_route";
...
export default function script(
  ...
  if (event.topic === "/bt785") {
    const value = event.message.temperature;
      ...
      features: [
        {
          type: "Feature",
          properties: {
            name: "BT785 probe temperature",
            metadata: {
              "Temperature": `${latestValue.toFixed(1)} deg C`,
